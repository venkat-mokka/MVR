    ...
    public partial class InitialContext : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DaywiseSchedule", x => x.DayID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DepartmentDayUnitMapping_DaywiseSchedule_DayID",
                        column: x => x.DayID,
                        principalTable: "DaywiseSchedule",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCamp = table.Column<bool>(type: "bit", nullable: true),
                    IsType = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
